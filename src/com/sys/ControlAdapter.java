	...
	public void actionPerformed(ActionEvent e) {
		...
		if(com=="Add") {
			...
			if(ad.isSubmited(e.getSource())) {
				...
				res = addNewStudent();
				if(res==-1) {
					JOptionPane.showMessageDialog(ad, "Failure", "Message",JOptionPane.WARNING_MESSAGE);
				}else {
					JOptionPane.showInternalConfirmDialog(ad, "Success", "Message", JOptionPane.OK_OPTION, JOptionPane.INFORMATION_MESSAGE);
				}
